...
@section('title' , 'Admin - CategoriesList')
                ...
                <table class="table table-bordered text-center mb-0 bg-white">
                    <thead class="bg-secondary text-dark">
                        <tr>
                            ...
                            <th class="align-middle"><a style=" text-decoration: none;" href="catform"><button class="btn btn-primary ">Add Category</button>
                                    </a></th>
...
?>
                    ...
                    <tr>
                       ...
                       <a href="{{route('deletecategory', [$items->id])}}"
